...
class CurrentAccount extends Account {
    double serviceFee = balance * (0.05);
    CurrentAccount(){
        System.out.println(balance);
    }
    void cheque() {
        System.out.println("Cheque service available");System.out.println(balance);
    }
...
class SavingsAccount extends Account {
    ...
    void interest() {
        ...
        int t = sc.nextInt();
        // double TotalAmount = balance + balance * t * r;
        for(int i=1; i<=t; i++){
            balance = balance + balance * r;
        }
        // System.out.println("Total amount after adding Simple interest is " + TotalAmount);
        System.out.println("Total amount after adding Compound interest is " + balance);
    }
}
